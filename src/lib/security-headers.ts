...
export const defaultSecurityHeaders: SecurityHeadersConfig = {
  ...
  contentSecurityPolicy: [
    "default-src 'self'",
    `script-src 'self' 'unsafe-inline' 'unsafe-eval' ${thirdParty.clerkFrontendApi} https://clerk.dev https://*.clerk.accounts.dev https://supreme-tadpole-66.clerk.accounts.dev ${thirdParty.stripePublishableKeyDomain} ${thirdParty.captchaDomains.join(' ')} https://challenges.cloudflare.com https://assets.turnstile.com https://cdnjs.cloudflare.com https://unpkg.com https://*.cloudflareaccess.com`, // Allow Clerk, Stripe, CAPTCHA services, and unpkg for PDF.js
...
export const developmentSecurityHeaders: SecurityHeadersConfig = {
  ...
  contentSecurityPolicy: [
    "default-src 'self'",
    "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://api.clerk.dev https://clerk.dev https://*.clerk.accounts.dev https://supreme-tadpole-66.clerk.accounts.dev https://js.stripe.com https://www.google.com https://www.gstatic.com https://www.recaptcha.net https://hcaptcha.com https://*.hcaptcha.com https://challenges.cloudflare.com https://assets.turnstile.com https://cdnjs.cloudflare.com https://unpkg.com https://*.cloudflareaccess.com",
    "worker-src 'self' blob:", // Allow web workers from blob URLs (needed for Clerk)
    "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://*.clerk.accounts.dev https://cdnjs.cloudflare.com",
    "font-src 'self' https://fonts.gstatic.com https://cdnjs.cloudflare.com",
    "img-src 'self' data: https: blob: https://*.ytimg.com https://*.ggpht.com https://*.googleusercontent.com",
